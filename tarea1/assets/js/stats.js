...
let $stat1 = document.getElementById("parte1")
let $stat2 = document.getElementById("parte2")
let $stat3 = document.getElementById("parte3")
...
//dato1= capacidad y dato2=asistencia
...
function porcentaje(dato1, dato2){
    return ( dato2 / (dato1/100) ).toPrecision (4)// recorda lo que hace toprecision
}
